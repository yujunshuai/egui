...
static si_t desktop_default_widget_move(struct window * w, union message * msg)
{
    /* 更新位置 */
/*
...
static si_t desktop_default_widget_resize(struct window * w, union message * msg)
{
    /* 更新位置 */
/*
...
static si_t desktop_default_window_minimize(struct window * w, union message * msg)
{
/*
    NOT_USED(msg);
...
static si_t desktop_default_window_maximize(struct window * w, union message * msg)
{
/*
    NOT_USED(msg);
...
static si_t desktop_default_window_restore(struct window * w, union message * msg)
{
/*
    NOT_USED(msg);
*/
...
static si_t desktop_default_window_activate(struct window * w, union message * msg)//unchanged
{
    ...
    if(w->status == WINDOW_STATUS_MINMIZED_NORMAL 
        || w->status == WINDOW_STATUS_MINIMIZED_MAXIMIZED)
    {
        desktop_default_window_restore(w, msg);
    }
...
si_t desktop_default_callback(addr_t w, addr_t m)
{
    ...
    switch(msg->base.type)
    {
        ...
        */
            desktop_default_widget_move(self, msg);
            break;
        ...
        */
            desktop_default_widget_resize(self, msg);
            break;
        ...
        */
            desktop_default_window_minimize(self, msg);
            break;
        ...
        */
            desktop_default_window_maximize(self, msg);
            break;
        ...
        */
            desktop_default_window_restore(self, msg);
            break;
