...
extern void request_set_draw_polygon(struct packet_body_draw_polygon* body, si_t gd, const struct point* point, ui_t point_count);
extern si_t request_call_by_draw_polygon(addr_t arg, si_t (*callable)(si_t, struct point*, ui_t));
